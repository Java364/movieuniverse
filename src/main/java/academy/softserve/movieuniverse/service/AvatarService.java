...
public class AvatarService {
    ...
    public Avatar save(Avatar avatar) {
        ...
        if (avatar == null)
            throw new NotFoundException(ExceptionType.SAVE.getMessage() + " avatar");
        return avatar;
    }
    ...
    public Avatar update(Avatar avatar, Long id) {
        ...
        avatar = repository.save(avatar);
        if (avatar == null)
            throw new NotFoundException(ExceptionType.UPDATE.getMessage() + " avatar");
        return avatar;
    }
    ...
    public Avatar findById(Long id) {
        ...
        if (!avatarOptional.isPresent()) {
            throw new NotFoundException(ExceptionType.SELECT.getMessage() + "avatar with " + id.toString() + " ID");
        }
    ...
    public void deleteById(Long id) {
        if (id == null || findById(id) == null)
            throw new NotFoundException(ExceptionType.DELETE.getMessage() + "avatar with " + id.toString() + " ID");
