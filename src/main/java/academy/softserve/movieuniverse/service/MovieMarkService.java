...
public class MovieMarkService {
    ...
    public void delete(Long id) {
        if (id == null || !movieMarkRepository.findById(id).isPresent()) {
            throw new NotFoundException(ExceptionType.DELETE.getMessage() + " movieMark with " + id.toString() + " ID");
        }
    ...
    public MovieMark findById(Long id) {
        ...
        if (id == null || !movieMarkOptional.isPresent()) {
            throw new NotFoundException(ExceptionType.SELECT.getMessage() + " movieMark with " + id.toString() + " ID");
        }
